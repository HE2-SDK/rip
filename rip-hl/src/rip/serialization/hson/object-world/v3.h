...
namespace rip::serialization {
	...
	struct hson<GameInterface, models::BinaryFileV2<typename ucsl::reflection::providers::simplerfl<GameInterface>::template RootType<typename ucsl::resources::object_world::v3::reflections::ObjectWorldData<typename GameInterface::AllocatorSystem>>, typename GameInterface::AllocatorSystem>> {
		typedef models::BinaryFileV2<typename ucsl::reflection::providers::simplerfl<GameInterface>::template RootType<ucsl::resources::object_world::v3::reflections::ObjectWorldData<typename GameInterface::AllocatorSystem>>, typename GameInterface::AllocatorSystem> Model;
