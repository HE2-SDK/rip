...
#include <rip/serialization/json/mirage/v2.h>

namespace rip::serialization {
	template<typename AllocatorSystem, bool terrain, bool arrayVectors>
	struct json<models::NeedleArchiveV1<AllocatorSystem, terrain>, arrayVectors> {
		inline static yyjson_mut_val* save(yyjson_mut_doc* doc, const models::NeedleArchiveV1<AllocatorSystem, terrain>& model) {
		...
		inline static models::NeedleArchiveV1<AllocatorSystem, terrain> load(yyjson_doc* doc, yyjson_val* value) {
