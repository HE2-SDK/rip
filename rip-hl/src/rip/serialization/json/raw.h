...
namespace rip::serialization {
	template<typename Refl, typename AllocatorSystem, typename AddrType, std::endian endianness, bool byteswap_offsets, bool relative_offsets, bool arrayVectors>
	struct json<models::Raw<Refl, AllocatorSystem, AddrType, endianness, byteswap_offsets, relative_offsets>, arrayVectors> {
		inline static yyjson_mut_val* save(yyjson_mut_doc* doc, const models::Raw<Refl, AllocatorSystem, AddrType, endianness, byteswap_offsets, relative_offsets>& model) {
			...
			return rip::binary::serializeJson<arrayVectors>(doc, acc);
		}
		...
		inline static models::Raw<Refl, AllocatorSystem, AddrType, endianness, byteswap_offsets, relative_offsets> load(yyjson_doc* doc, yyjson_val* value) {
			typename rip::binary::accessors::template json<arrayVectors>::template ValueAccessor<Refl> acc{ { doc, value }, Refl{} };
